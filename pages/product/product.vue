			...
			<view class="layer attr-content" @click.stop="stopPrevent">
				...
				<view v-for="(item,index) in specList" :key="index" class="attr-list">
					...
					<view class="item-list">
						<text v-for="childItem in filteredSpecChildList(item.id)" :key="childItem.childIndex" class="tit"
						 :class="{selected: childItem.selected}" @click="selectSpec(childItem.childIndex, childItem.pid)">
							{{childItem.name}}
						</text>
					</view>
				</view>
